...
```
目標：     接手 2026/09/19 Daily Update #75 失敗狀態，以安全 fallback 更新單一維護PR #127。
...
已完成：   run #75六館爬蟲與資料管線成功，但舊main仍有3項到期衍生資料錯誤及1項動態稽核快照失敗，故未建立自動PR或artifact；本輪未重跑Playwright。
           掃描Slack 2則、拆分去重後7候選；台灣「九你玩～塗鴉躲貓貓」缺可驗證開始日，Pokémon氣球派對為門市促銷，其餘海外、線上或一般上映，均未收錄。
           六館快取沿用最近成功的#133 head；9/19沒有公開活動新增或到期，資料維持160場館、168圖釘、47群組。
目前錯誤： 今日自動run #75無PR head或artifact，無法接手或比對其新抓generated；#127本地測試與硬性門檻均通過。
下一步：   將9/19日期衍生層更新至單一維護PR #127並確認雲端CI；待九乘九活動開始日、必要metadata及正式KV可查證後再評估，Daniel合併#127後可讓main取得既有測試修正。
