...
```
目標：     接手 2026/09/09 Daily Update #65／自動PR #129，整合最新六館資料與 Slack 新活動至單一維護PR #127。
...
已完成：   run #65、自動PR #129及其CI均成功；以#129 head為最新六館來源，保留#127的駁二部分清單防護並補回4筆仍有效缺項。
           收錄「台中超動漫研究社快閃店」1圖釘；木棉花官方活動頁／KV、免費、地址與座標均已查證並落入持久SSOT。
           SIF首爾插畫展因非明確ACG且主辦／授權／費用未公開，維持隔離，不硬猜分類或欄位。
目前錯誤： 無；公開資料247場館、263圖釘、60群組，KV 263/263穩定自存，131項backend測試與硬性門檻全部通過。
下一步：   將本輪變更更新至單一維護PR #127，確認雲端CI後等待Daniel明確同意；自動PR #129應標記由#127取代。
